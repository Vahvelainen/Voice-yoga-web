...
<script>
  ...
  <section>
    {#if !complete}
      <Voiceline txt={'Inhale and return to an upright po - sition. Rise and straighten your arms so that your palms meet. Recall the second pose'}/>
    ...
    {:else}
      <Voiceline txt={'Excellent, you have finished all the poses. Exhale and let your hands fall down slowly to your side, palms facing forward.'}/>
    {/if}
  </section>
